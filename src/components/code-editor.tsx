  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 bg-bg-input">
        {/* Line Numbers */}
        <div className="flex flex-col items-end gap-2 py-4 px-3 w-12 border-r border-border-primary bg-bg-surface select-none">
        ...
        <textarea
          ...
          spellCheck={false}
          className="flex-1 py-[11px] px-4 bg-transparent font-mono text-xs text-text-primary placeholder:text-text-tertiary outline-none resize-none min-h-80 leading-6"
        />
      </div>
    </div>
  );
